...
const createModal = (title, description) => {
    const overlayElem = createElem('div', {
        className: 'modal'
    });
    const modalElem = createElem('div', {
    ...
    const hiddenInput = createElem('input', {
        type: 'hidden',
        name: 'product',
        value: 'title',
    });
    ...
    formElem.append(nameLabelElem, phoneLabelElem, hiddenInput);
